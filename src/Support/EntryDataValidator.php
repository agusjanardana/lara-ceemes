...
final class EntryDataValidator
{
     ...
     */
    public function validate(Blueprint $blueprint, array $data): array
    {
        $blueprintFields = $blueprint->fields()->get();
        $knownHandles = $blueprintFields->pluck('handle')->all();
    ...
    /** @return array<string, mixed> */
    private function config(BlueprintField $field): array
    {
