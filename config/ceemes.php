...
return [
    ...
    'users' => [
        ...
        'key_type' => 'integer',
        'foreign_keys' => true,
        'manage_role_column' => env('CEEMES_MANAGE_USER_ROLE_COLUMN', true),
        'role_attribute' => env('CEEMES_USER_ROLE_ATTRIBUTE', 'role'),
        'default_role' => env('CEEMES_DEFAULT_USER_ROLE', 'user'),
        'superadmin_role' => env('CEEMES_SUPERADMIN_ROLE', 'superadmin'),
        'name_attribute' => 'name',
